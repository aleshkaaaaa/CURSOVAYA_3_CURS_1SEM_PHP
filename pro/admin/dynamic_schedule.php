                        ...
                        <div class="card-header">
                            ...
                            <div class='float-right'>
                                <button type="button" class="btn btn-primary btn-sm" data-toggle="modal"
                                    data-target="#add">
                                    Добавить одноразовое расписание &#128645;
                            ...
                            <table id="example1" style="align-items: stretch;"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th>Поезд</th>
                                        <th>Маршрут</th>
                                        <th>Стоимость билета 1 класса</th>
                                        <th>Стоимость обычного билета</th>
                                        <th>Всего мест</th>
                                        <th>Дата/Время</th>
                                        <th></th>
                                    </tr>
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h4 class="modal-title">Изменение маршрута &#128642;</h4>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <form action="" method="post">
                                                        ...
                                                        <p>
                                                            Плата за первый класс : <input class="form-control"
                                                                type="number" value="<?php echo $fetch['first_fee'] ?>"
                                                                name="first_fee" required id="">
                                                        </p>
                                                        <p>
                                                            Плата за обычный класс : <input class="form-control"
                                                        ...
                                                        <p>
                                                            Время : <input class="form-control" type="time"
...
<div class="modal fade" id="add">
    <div class="modal-dialog modal-lg">
        <div class="modal-content" align="center">
            <div class="modal-header">
                <h4 class="modal-title">Добавить одноразовое расписание &#128649;
                </h4>
            ...
            <div class="modal-body">
                <form action="" method="post">
                    <div class="row">
                        <div class="col-sm-6">
                            Поезд : <select class="form-control" name="train_id" required id="">
                                <option value="">Выберите поезд</option>
                                <?php
                        ...
                        <div class="col-sm-6">
                            Маршрут : <select class="form-control" name="route_id" required id="">
                                <option value="">Выберите маршрут</option>
                                <?php
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            Плата за первый класс : <input class="form-control" type="number" name="first_fee" required
                                id="">
                        </div>
                        <div class="col-sm-6">

                            Плата за обычный класс : <input class="form-control" type="number" name="second_fee" required
                                id="">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6">
                            Дата : <input class="form-control" onchange="check(this.value)" type="date" name="date"
                                required id="date">
                        </div>
                        <div class="col-sm-6">

                            Время : <input class="form-control" type="time" name="time" required id="">
                        </div>
                    </div>
                    <hr>
...
<div class="modal fade" id="add2">
    <div class="modal-dialog modal-lg">
        <div class="modal-content" align="center">
            <div class="modal-header">
                <h4 class="modal-title">Добавить постоянное расписание &#128649;
                </h4>
            ...
            <div class="modal-body">
                <form action="" method="post">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            Дата начала расписания : <input class="form-control" onchange="check(this.value)" type="date"
                                name="from_date" required>
                        </div>
                        <div class="col-sm-6">
                            Дата окончания расписания : <input class="form-control" onchange="check(this.value)" type="date"
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            Дата : <input class="form-control" type="time" name="time" required id="">
                        </div>
                    </div>
                    <hr>
