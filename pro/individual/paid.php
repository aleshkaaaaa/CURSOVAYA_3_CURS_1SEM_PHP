...
if (isset($_GET['now'])) {
    echo "<script>alert('Оплата прошла успешно');window.location='individual.php?page=paid';</script>";
    exit;
}
            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header alert-success">
                        <h5 class="m-0">Купленные билеты</h5>
                    </div>
                    <div class="card-body">
