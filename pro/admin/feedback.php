                                        ...
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h4 class="modal-title">Ответить на сообщение пассажира <?php echo $fullname; ?></h4>
                                                ...
                                                <div class="modal-body">
                                                    <form action="" method="post">
                                                        ...
                                                        <p>Ответ : <textarea class="form-control" name="reply" required
                                                                minlength="3"></textarea>

                                                        <p>

                                                            <input class="btn btn-info" type="submit" value="Ответить"
                                                                name='send_reply'>
                                                        </p>
                                                    </form>
